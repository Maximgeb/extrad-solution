...
const waUrl = `${WHATSAPP_LINK}?text=${encodeURIComponent("Bonjour, je souhaite obtenir un devis personnalisé pour un rapatriement depuis Dubaï.")}`;
...
const ROUTES = [
  { from: "Dubaï", to: "Paris CDG", price: "14 999€", note: "Par siège · Départ 72h", featured: true },
  { from: "Abu Dhabi", to: "Paris CDG", price: "Sur devis", note: "Délai similaire", featured: false },
  { from: "Sharjah", to: "Paris CDG", price: "Sur devis", note: "Coordonné depuis DXB", featured: false },
  { from: "Dubaï", to: "Autre EU", price: "Sur devis", note: "Devis personnalisé", featured: false },
];
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12" ref={ref}>
        ...
        <div className="mb-16">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            >
              Prix forfaitaire tout compris. Devis personnalisé fourni dans les 2 heures
              suivant votre contact.
            </motion.p>
          </div>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
          {/* Featured card — Dubai CDG */}
          <motion.div
          ...
          >
            ...
            <div className="p-8 md:p-10">
              ...
              <div className="flex items-center gap-3 mb-8">
                <span className="text-[rgba(245,240,235,0.6)] text-sm font-inter">Dubaï</span>
                <motion.div
                  initial={{ scaleX: 0 }}
                ...
                />
                <span className="text-[#F5F0EB] text-sm font-inter font-medium">Paris CDG</span>
              </div>
              ...
              <div className="mb-6">
                ...
                <span className="text-[rgba(245,240,235,0.4)] text-xs font-inter tracking-wide mt-2 block">
                  Par siège · Tout compris · Départ sous 72h
                </span>
              </div>
          ...
          >
            ...
            >
              ...
              <div className="space-y-4">
                {ROUTES.filter((r) => !r.featured).map((route, i) => (
                  <motion.div
                    ...
                    style={{ borderBottom: i < 2 ? "1px solid rgba(42,42,42,0.8)" : "none" }}
                  >
                    <div>
            ...
            >
              <p className="text-[#F5F0EB] text-base font-playfair font-semibold tracking-[-0.02em] mb-2">
                Situation hors standard&nbsp;?
              </p>
              <p className="text-[rgba(245,240,235,0.5)] text-sm leading-[1.7] mb-5">
                Groupe familial, animaux, documents complexes, urgence extrême&nbsp;—
                nous établissons un devis personnalisé sous 2 heures.
              </p>
              <a
                href={waUrl}
                target="_blank"
