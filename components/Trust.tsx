...
export default function Trust() {
  ...
  return (
    <section id="confiance" className="py-28 md:py-36 bg-[#0A0A0A] relative overflow-hidden">
      {/* Ambient */}
      <div
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-12" ref={ref}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 mt-3">
          ...
          >
            <p className="text-[rgba(245,240,235,0.35)] text-[9px] tracking-[0.2em] uppercase font-inter mb-7">
              {t.trust.includesLabel}
            </p>
            <ul className="space-y-4">
              {t.trust.includes.map((item, i) => (
                <motion.li
                  key={item}
